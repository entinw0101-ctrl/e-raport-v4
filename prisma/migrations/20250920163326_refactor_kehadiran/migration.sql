...
-- CreateEnum
CREATE TYPE "public"."StatusKehadiran" AS ENUM ('HADIR', 'SAKIT', 'IZIN', 'ALPA');
...
CREATE TABLE "public"."kehadiran" (
    ...
    "siswa_id" INTEGER NOT NULL,
    "periode_ajaran_id" INTEGER NOT NULL,
    "indikator_kehadiran_id" INTEGER NOT NULL,
    "tanggal" TIMESTAMP(3) NOT NULL,
    "status" "public"."StatusKehadiran" NOT NULL,
    "dibuat_pada" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "diperbarui_pada" TIMESTAMP(3) NOT NULL,
...
-- CreateTable
CREATE TABLE "public"."indikator_kehadiran" (
    "id" SERIAL NOT NULL,
    "indikator" VARCHAR(255),
    "is_active" BOOLEAN NOT NULL DEFAULT true,
    "dibuat_pada" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    ...
    CONSTRAINT "indikator_kehadiran_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "kehadiran_indikator_kehadiran_id_idx" ON "public"."kehadiran"("indikator_kehadiran_id");

-- CreateIndex
CREATE INDEX "kehadiran_tanggal_idx" ON "public"."kehadiran"("tanggal");

-- CreateIndex
CREATE INDEX "kehadiran_siswa_id_periode_ajaran_id_idx" ON "public"."kehadiran"("siswa_id", "periode_ajaran_id");

-- CreateIndex
CREATE UNIQUE INDEX "kehadiran_siswa_id_periode_ajaran_id_tanggal_indikator_keha_key" ON "public"."kehadiran"("siswa_id", "periode_ajaran_id", "tanggal", "indikator_kehadiran_id");
...
-- CreateIndex
CREATE INDEX "indikator_kehadiran_is_active_idx" ON "public"."indikator_kehadiran"("is_active");
...
-- AddForeignKey
ALTER TABLE "public"."siswa" ADD CONSTRAINT "siswa_tahun_ajaran_masuk_id_fkey" FOREIGN KEY ("tahun_ajaran_masuk_id") REFERENCES "public"."master_tahun_ajaran"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "public"."kehadiran" ADD CONSTRAINT "kehadiran_indikator_kehadiran_id_fkey" FOREIGN KEY ("indikator_kehadiran_id") REFERENCES "public"."indikator_kehadiran"("id") ON DELETE CASCADE ON UPDATE CASCADE;
